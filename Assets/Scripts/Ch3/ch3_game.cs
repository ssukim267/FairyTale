...
public class ch3_game : MonoBehaviour
{
    ...
    IEnumerator RunDialogueSequence()
    {
        ...
        yield return StartCoroutine(PlayDialogue("이것은 비와 눈, 그리고 햇빛을 막아주는 특별한 도구야! 이것을 펴면 커다란 천이 펼쳐져서 머리 위에 작은 집이 생기는 것 같아.  "));
        yield return StartCoroutine(PlayDialogue("그림을 그렸으면 선택완료 버튼을 눌러줘."));

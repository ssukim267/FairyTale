Shader "Hidden/NOT_Lonely/Weatherade/Snow Coverage (Terrain-Bake)"
{
    Properties
    {
		...
		_CoverageAreaBias("Coverage Area Bias", Range( 0.001 , 0.3)) = 0.0
    ...
    Dependency "AddPassShader" = "Hidden/NOT_Lonely/Weatherade/Snow Coverage (Terrain Add Pass-Bake)"
